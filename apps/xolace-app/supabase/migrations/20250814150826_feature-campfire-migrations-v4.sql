CREATE INDEX idx_campfire_members_user_campfire ON public.campfire_members USING btree (user_id, campfire_id);

CREATE INDEX idx_posts_campfire_created_at ON public.posts USING btree (campfire_id, created_at DESC) WHERE (campfire_id IS NOT NULL);
