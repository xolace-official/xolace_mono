...
export const dummyPosts: EnhancedPost[] = [
    {
        ...
        mood: 'thoughtful',
        type: 'single',
        content: 'Just finished a really insightful therapy session today. Sometimes the breakthrough moments come when we least expect them. Remember, healing isn\'t linear - it\'s okay to have ups and downs. 💜\n\nWhat\'s one thing you\'re grateful for today?',
    ...
    },
    {
        ...
        mood: 'sad',
        type: 'single',
        content: 'Having a really tough day today. Anxiety is through the roof and I can\'t seem to calm down. Does anyone have any grounding techniques that work for them?\n\nI feel like I\'m drowning...',
        post_slides: undefined,
        prompt_text: null,
        posttags: [
            { name: 'anxiety' },
    ...
    },
    {
        ...
        mood: 'melancholy',
        type: 'single',
        content: 'Been feeling really disconnected from myself lately. Like I\'m just going through the motions but not really living.\n\nAnyone else ever feel like this? How do you reconnect with yourself?',
        post_slides: undefined,
