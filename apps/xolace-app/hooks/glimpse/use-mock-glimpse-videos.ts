...
import type { GlimpseVideo, GlimpseSortOptionTypes} from '../../features/glimpse/types'
...
export function useMockGlimpseVideos(searchQuery: string, sortOption: GlimpseSortOptionTypes) {
