    ...
    return (
        <View className={" flex-row justify-center items-center gap-2"}>
            <AnimatedPressable onPress={onLeftPress}>
                <Animated.View style={[styles.button, leftButtonStyle, leftAnimatedStyle]}>
                    <AnimatedIcon name="arrow-left" size={20} color="white" style={[styles.icon]} onPress={onFinish} />
                </Animated.View>
            ...
            <AnimatedPressable onPress={onRightPress}>
                <Animated.View style={[styles.button, rightButtonStyle, rightAnimatedStyle]}>
                    <AnimatedIcon name="arrow-right" size={20} color="white" style={[styles.icon]} onPress={onFinish} />
                </Animated.View>
