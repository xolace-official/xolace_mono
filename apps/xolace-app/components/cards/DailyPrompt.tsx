...
import { ArrowRight, CalendarDays, Sparkles, Tag } from 'lucide-react-native';
import { ActivityIndicator, Pressable, View } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';

import { Button, Card, Text } from '@xolacekit/ui';
...
export function DailyPrompt() {
  ...
  const { gradient, accent, button, glow } = getThemeColors(
    promptData.category,
  );
          ...
          <View className="relative z-10 px-4 py-3">
            ...
            <View className="mb-1 flex flex-row items-center justify-between">
              ...
              <View className="flex flex-row items-center gap-1">
                ...
                >
                  {showUrgencyIndicator && <Text className="text-sm">⏳</Text>}
                  {isLoadingStreak ? (
            ...
            <Button
              ...
              className={cn('mt-2 w-full rounded-lg py-3.5 shadow-md', button)}
            >
