    ...
    <Card className={cn('relative rounded-none border-x-0 pt-3', className)}>
        ...
        <View className="flex flex-row items-center gap-3">
          ...
          <View className="flex flex-col items-start justify-center">
            <View className="flex flex-row items-center gap-2">
              ...
              <Pressable
                onPress={() => console.log('Navigate to campfire/profile')}
              >
            ...
            <View className="flex flex-row items-center gap-2">
              ...
              <Text className="text-[13px] text-zinc-500 dark:text-gray-400">
                {timestamp}
              </Text>
              ...
              {post.is_campfire_post && (
                <Badge variant="secondary" className="py-[1px]">
                  <Text className="text-[10px] text-purple-400">CAMPFIRE</Text>
                </Badge>
              )}

              {timeLeft && (
                <Badge variant="secondary" className="py-[1px] text-[10px]">
      ...
      {post.is_sensitive &&
        ...
        post.created_by !== currentUserId && (
          <View className="absolute inset-0 flex items-center justify-center rounded-lg bg-black/60">
            <Text className="font-semibold text-white">Sensitive Content</Text>
            <Pressable onPress={() => console.log('Show sensitive content')}>
              <Text className="mt-2 text-white underline">Tap to view</Text>
            </Pressable>
          </View>
        )}
    </Card>
