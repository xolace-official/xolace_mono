    ...
    return (
        <>
            ...
            <Card
                ...
                className='bg-white dark:bg-[#020617] border border-slate-200 dark:border-slate-800 shadow-sm shadow-slate-200 dark:shadow-slate-800 mt-10'
                onPress={() => router.push('/')}
            >
                {/* <Card.Section
                    ...
                    <View row spread centerV>
                        <View row>
                            <View row marginR-20 centerV>
                                    ...
                                    />
                                <Text text90 className="text-gray-600 dark:text-gray-400"> {post.likes}</Text>
                            </View>
                            <View row centerV>
                                <Button
                                    style={{marginRight: 3}}
