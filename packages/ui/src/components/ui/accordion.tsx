...
function Accordion({
  ...
  RefAttributes<AccordionPrimitive.RootRef>) {
  return (
...
function AccordionItem({
  ...
  value,
  ...props
}: AccordionPrimitive.ItemProps & RefAttributes<AccordionPrimitive.ItemRef>) {
  return (
...
function AccordionTrigger({
  ...
  children?: ReactNode;
} & RefAttributes<AccordionPrimitive.TriggerRef>) {
...
function AccordionContent({
  ...
  children,
  ...props
}: AccordionPrimitive.ContentProps & RefAttributes<AccordionPrimitive.ContentRef>) {
  const { isExpanded } = AccordionPrimitive.useItemContext();
  return (
